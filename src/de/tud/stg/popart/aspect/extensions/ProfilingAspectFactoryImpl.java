 ...
 */
public class ProfilingAspectFactoryImpl extends AspectFactory {
	
	public Aspect createAspect(Map<String,Object> params, ContextDSL interpreter, Closure definition) {
		return new ProfilingAspect(params, interpreter, definition);
	}

	public void initAspectMetaObjectClass() {
		setDefaultMetaAspectFor(ProfilingAspect.class);
	}
