...
public class InductiveWrappingCCCombiner extends CCCombiner {
  
  public InductiveWrappingCCCombiner(List<AutoComposable> dslDefinitions, Object context) {
    super(dslDefinitions, context);
    
    AspectFactory.defaultComparator =
      new InductiveWrappingCCCombinerComparator<AspectMember>(dslDefinitions);
  }
