 ...
 * @author Oliver Rehor
 **/
public class CoCaZipComparator<T extends AspectMember> extends ApplicationSpecificComparator<T> {
  ...
  public int compare(T to1, T to2) {
    ...
    if (mDebug)
      debugMsg("Comparator", "compare '" + o1Name + "':'" + o2Name + "'");
    ...
    else if (o1Name.startsWith("zipAround") && o2Name.startsWith("cachingAround"))
      return 1;
