...
/**
 * This {@link OneLevelStructureDesignator} matches a stored Class
 * exactly against supplied Class instances.
...
public class ClassSD extends OneLevelStructureDesignator{
	 ...
	 * @param c the class
	 */
	public ClassSD(Class<?> c){
		super("Type("+c.getCanonicalName()+")");
		this.c=c;
	}
