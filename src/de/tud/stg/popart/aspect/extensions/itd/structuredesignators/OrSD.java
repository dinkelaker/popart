...
/**
 * This StructureDesignator represents the logical "or" concatenation of
...
public class OrSD extends StructureDesignator{
	 ...
	 */
	public OrSD(StructureDesignator a, StructureDesignator b){
		super("or("+a+","+b+")");
		this.a=a;
		this.b=b;
	}
	...
	/**
	 * Matches if the first or the second StructureDesignator match.
	 */
