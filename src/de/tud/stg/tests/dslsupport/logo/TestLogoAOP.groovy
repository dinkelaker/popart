...
import de.tud.stg.popart.dslsupport.logo.exceptions.OutOfCanvasException; 
import de.tud.stg.popart.dslsupport.logo.dspcl.LogoPointcutInterpreter;
...
public class TestLogoAOP extends TestCase {
	...
	void testDomainSpecificConstraints() {
		...
		try {
			...
			fail("Caught another error than OutOfCanvasException.");
		}
