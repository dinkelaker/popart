...
public class TestSuiteLogo extends TestSuite {
	  ...
	  public static TestSuite suite() throws Exception {
	    ...
	    suite.addTestSuite(TestMetaLogo.class);
	    ...
	    suite.addTestSuite(TestLogoAOP.class);
	  ...
	  public static void main(String[] args) {
		  ...
		  //add tests to be invoked explicitly...
		  //new TestConcurrentLogo().testThreadedSquares();
	  }
