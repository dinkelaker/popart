...
public aspect AssignmentInstrumentation {
  ...
  Object around () : set(* *.*) && inExamples() {
    //System.out.println("Assignment of '" + thisJoinPoint.getSignature() + "'");
    if (DEBUG) System.out.println("INSTRUMENTATION: \t before initialization "+thisJoinPoint.getSignature().getName());
	Map<String,Object> context = new java.util.HashMap<String,Object>();
    context.put("fieldName", thisJoinPoint.getSignature().getName());
    ...
    JoinPoint jp = new FieldAssignmentJoinPoint(
