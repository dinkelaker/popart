 ...
 * @author Oliver Rehor
 **/
public class BoundedBufferTest extends TestSuite {
  ...
  public static TestSuite suite() throws Exception {
    ...
    addBoundedBufferTest(BoundedBufferTestCase.class, suite);
    
    return suite;
  }
  
  private static void addBoundedBufferTest(Class testClass, TestSuite suite) {
