 ...
 * @author Oliver Rehor
 **/
public class BrokenBoundedBufferTest extends TestSuite {
  ...
  public static TestSuite suite() throws Exception {
    ...
    addBoundedBufferTest(BrokenBoundedBufferTestCase.class, suite);
    
    return suite;
  }
  
  static void addBoundedBufferTest(Class testClass, TestSuite suite) {
	final String path = "src/de/tud/stg/tests/popart/extensions/cool/boundedbuf/"
