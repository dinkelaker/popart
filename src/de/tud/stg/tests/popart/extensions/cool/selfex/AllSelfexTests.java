...
public class AllSelfexTests extends TestSuite {
  ...
  public static TestSuite suite() throws Exception {
    ...
    addMutexTest(BookAdderTestCase.class, suite);
    
    return suite;
  }
  
  private static void addMutexTest(Class testClass, TestSuite suite) {
    final String path = "src/de/tud/stg/tests/popart/extensions/cool/selfex/"
