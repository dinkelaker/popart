 ...
 * @author Oliver Rehor
 **/
public class AllCoCaZipTests extends TestSuite {
  ...
  public static TestSuite suite() throws Exception {
    ...
    addCoCaZipTest(Archive.class, suite);

    return suite;
  }
  
  private static void addCoCaZipTest(Class testClass, TestSuite suite) {
    final String path = "src/de/tud/stg/tests/popart/extensions/coolcachingzip/"
